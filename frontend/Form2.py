...
class Form2(Form2Template):
  ...
  def get_ticker(self):
    ...
    if anvil.server.call('test_ticker', stock_str):
      opt = anvil.server.call("get_opt_dates_yf", stock_str)
  ...
  def get_option(self):
    call, put = anvil.server.call("get_opt_markdown_yf", self.text_box_1.text.strip().upper(), self.drop_down_1.selected_value)
  ...
  def button_3_click(self, **event_args):
    ...
    res = anvil.server.call("ask_google_csv", self.text_box_1.text.strip().upper(), self.drop_down_1.selected_value, True)
